/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 1e8c209024e001e30af02184a0398201)
// Runtime types generated with workerd@1.20260911.1 2025-09-12 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	LOBBY_STORE: DurableObjectNamespace<import("./custom-worker").LobbyStoreDO>;
	WORKER_SELF_REFERENCE: Service<typeof import("./custom-worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "LobbyStoreDO";
	}
